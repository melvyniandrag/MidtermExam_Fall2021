...
\iknow{cp -r}{This command is to copy all files in a directory}
\iknow{mv}{This command is to move multiple files or rename a file}
\iknow{rm}{this command is to delete a file}
\iknow{rm -r}{this command is to delete a directory}
\iknow{ls -a}{this command is to list all files and directories}
\iknow{ls -al}{this command is to list all files and directories and its details}
\iknow{ls -l}{this command is to list details of files and directories}
\iknow{ssh}{this command is to connect to a remote server or system}
\iknow{ssh-keygen}{this command is to generate a public ssh key and a private ssh key}
\iknow{cd}{this command is to change directory}
\iknow{cd ../}{this command is to change to last directory}
\iknow{cd \textasciitilde}{this command is to change to directory call "textasciitilde"}
\iknow{echo}{this command is to print out a string}
\iknow{cat}{this command is to print out content of a file}
\iknow{adduser}{this command is to add a user to the current system}
\iknow{deluser}{this command is to delete a user from the current system}
\iknow{chmod}{this command is to change read/write/execute mode of a file or directory}
\iknow{chown}{this command is to change owner user of a file or directory}
