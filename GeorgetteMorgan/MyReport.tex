...
\iknow{cp -r}{This comand is used to copy directories}
\iknow{mv}{This comand to to rename a file}
\iknow{rm}{This comand is uded to delet}
\iknow{rm -r}{This comand is used to remove directory}
\iknow{ls -a}{This comand is used to see hidden files}
\iknow{ls -al}{This comand is used to give you hidden files}
\iknow{ls -l}{will give file name and more}
\iknow{ssh}{network comunication to log in }
\iknow{ssh-keygen}{to get my ssh key}
\iknow{cd}{to go back to home directory}
\iknow{cd ../}{to go up one directory}
\iknow{cd \textasciitilde}{to change directory into textasciitilde}
\iknow{echo}{it repeats or compine}
\iknow{cat}{to glue the files}
\iknow{adduser}{This is used adduser}
\iknow{deluser}{This is used to delet user}
\iknow{chmod}{This is used to modify a user permison}
\iknow{chown}{This is used to change the owner of the file}
