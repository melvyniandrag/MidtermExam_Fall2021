...
\iknow{mv}{this command is used to move files}
\iknow{rm}{this command deletes files}
\iknow{rm -r}{this command deletes directory}
\iknow{ls -a}{this command list current directory including hidden files}
\iknow{ls -al}{this command displays file and subdirectories in current directy}
\iknow{ls -l}{this command list files and directories}
\iknow{ssh}{this command connects two hosts}
\iknow{ssh-keygen}{this command creates ssh key}
\iknow{cd}{this command changes directory}
\iknow{cd ../}{this command changes to root directory}
\iknow{cd \textasciitilde}{this command changes to subdirectories}
\iknow{echo}{this command repeats a message}
\iknow{cat}{this command prints}
\iknow{adduser}{this command adds a user}
\iknow{deluser}{this command deletes a user}
\iknow{chmod}{this command changes mode}
\iknow{chown}{this command changes owner}
